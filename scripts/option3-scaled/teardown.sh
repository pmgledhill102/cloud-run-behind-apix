...
#
# Tears down in reverse dependency order: Cloud Run services first (to release
# VPC address reservations), then DNS, PSC, VM, firewall, subnet, VPC,
...
# ============================================================
echo "--- Step 1: Delete ${SERVICE_COUNT} Cloud Run services ---"
...
# ============================================================
# Step 4: Delete PSC forwarding rule and IP reservation
# ============================================================
echo ""
...
# ============================================================
# Step 5: Delete Cloud NAT
# ============================================================
echo ""
echo "--- Step 5: Delete Cloud NAT ---"
...
# ============================================================
echo ""
echo "--- Step 6: Delete firewall rules ---"
...
# ============================================================
# Step 9: Delete Artifact Registry
# ============================================================
echo ""
echo "--- Step 9: Delete Artifact Registry repository ---"
...
# ============================================================
# Step 10: Remove IAM bindings and delete service account
# ============================================================
echo ""
echo "--- Step 10: Remove IAM bindings ---"
...
echo ""
echo "--- Step 11: Delete service account ---"
if gcloud iam service-accounts describe "${SA_EMAIL}" --project="${PROJECT_ID}" &>/dev/null; then
